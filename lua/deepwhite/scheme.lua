...
function M.get_groups(c)
	return {
		...
		Comment = { fg = c.base3, italic = true },
        ...
        -- neorg
        -- headings
        ["@neorg.headings.1.title.norg"] = { fg = c.base0, bg = c.light_blue },
        ["@neorg.headings.1.prefix.norg"] = { fg = c.base0, bg = c.light_blue },
        ["@neorg.links.location.heading.1.norg"] = { fg = c.base0, bg = c.light_blue },
        ["@neorg.links.location.heading.1.prefix.norg"] = { fg = c.base0, bg = c.light_blue },
        -- markup
        ["@neorg.markup.bold.norg"] = { fg = c.blue, bg = c.light_blue, bold = true },
        ["@neorg.markup.italic.norg"] = { fg = c.green, bg = c.light_green, italic = true },
        ["@neorg.markup.underline.norg"] = { fg = c.cyan, bg = c.light_cyan, underline = true },
        ...
        ["@neorg.quotes.3.content.norg"] = { fg = c.base0, bg = c.light_yellow },
